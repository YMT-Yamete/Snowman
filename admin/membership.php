...
<body> 
    ...
    <div style="padding: 10px;">
        <p class="fieldHeader">Members</p><br><br>

        <table class="center">
            <tr>
                <td><a class="nav-link active" href="membership.php" style="color: blue;">Members</a></td>
                <td><pre>    </pre></td>
        ...
        <table data-replace="jtable" aria-label="JS Datatable" data-locale="en" data-search="true">
            ...
            <tbody>
                <?php 
                    $today = date('Y-m-d');
                    $select = "SELECT * FROM membership WHERE Status = 'Accepted' AND EndDate > $today";
                    ...
                    for ($i=0; $i < $count; $i++) { 
                        ...
                        echo "<td style='text-align:center;'>$startDate</td>";
                        echo "<td style='text-align:center;'>$endDate</td>";
                        echo "</tr>";
                    }
               ?>
            </tbody>
    ...
    <footer class="footer-distributed" style="<?php print ($count>10)?'margin-top: 0px':'position: fixed'; ?>">
