...
<body>
    ...
    <div class="card">
        <h1 class="fieldHeader">Cleaning Booking</h1><br><br>
        <div class="textCenter">
            <p class="formQues">What's the size your car?</p><br>
            <img src="assets/car-sizes.png" alt="image" height="100" class="hoverBig" /><br><br>
            <form method="POST" action="cleaningBooking.php">
                <table class="center"width="20%">
                    <tr>
                        <td><input type="radio" name="service" value="small car cleaning" class="radioButton"></td>
                        <td class="textLeft">Small/Medium<br></td>
                    </tr>
                    <tr>
                        <td><pre> </pre></td>
                    </tr>
                    <tr>
                        <td><input type="radio" name="service" value="large car cleaning" class="radioButton"></td>
                        <td class="textLeft">Large<br></td>
                    </tr>
                    <tr>
                        <td><pre> </pre></td>
                    </tr>
                    <tr>
                        <td><input type="radio" name="service" value="XL car cleaning" class="radioButton"></td>
                        <td class="textLeft">Extra Large(XL)<br></td>
                    </tr>
                </table>        
            </div>
            <table class="center"> 
